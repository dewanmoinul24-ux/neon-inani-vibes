    ...
    <section className="py-20 md:py-32 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <p className="font-ui text-sm uppercase tracking-[0.3em] text-neon-purple mb-3" style={{ textShadow: "0 0 10px hsl(270 80% 60% / 0.8)" }}>
            What's your vibe?
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {moods.map((mood, i) => {
            ...
            return (
              <button
                key={mood.label}
                className="group glass rounded-xl p-6 text-center neon-border-pink transition-all duration-500 hover:neon-glow-pink hover:scale-[1.05] animate-slide-up"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                <div className={`w-14 h-14 mx-auto mb-4 rounded-full bg-gradient-to-br ${mood.gradient} flex items-center justify-center transition-transform duration-300 group-hover:scale-110`}>
