...
const PlacesSection = () => {
  return (
    <section id="places" className="py-20 md:py-32 relative">
      <div className="absolute top-0 left-1/4 w-80 h-80 bg-neon-cyan/5 rounded-full blur-[120px]" />
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <p className="font-ui text-sm uppercase tracking-[0.3em] text-neon-blue mb-3 neon-text-blue">
            Discover paradise
          </p>
        ...
        <div className="space-y-12">
          {places.map((place, i) => (
            <div
              key={place.name}
              className={`flex flex-col ${i % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"} gap-6 md:gap-10 items-center animate-slide-up`}
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg glass text-sm font-ui">
                    <Clock size={14} className="text-neon-cyan" />
                    <span className="text-muted-foreground">Best:</span>
                    <span className="text-foreground">{place.bestTime}</span>
                  </span>
                  <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg glass text-sm font-ui">
                    <Camera size={14} className="text-neon-pink" />
